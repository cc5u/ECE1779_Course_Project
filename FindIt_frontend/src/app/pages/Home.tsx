...
export default function Home() {
  const lostReports = [
    ...
    },
    {
      ...
      time: '5 hours ago',
      status: 'Possibly Found' as const,
      imageUrl: 'https://images.unsplash.com/photo-1728034261598-a452ccc3a7a5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxibHVlJTIwYmFja3BhY2slMjBiYWd8ZW58MXx8fHwxNzcyMzkyODk1fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    },
    {
      ...
      time: '1 day ago',
      status: 'Lost' as const,
      imageUrl: 'https://images.unsplash.com/photo-1752346800862-252719b8315d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzaWx2ZXIlMjBob3VzZSUyMGtleXN8ZW58MXx8fHwxNzcyMzkyODk1fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    },
  ];

  // Example map pins coordinates (relative positions)
  const mapPins = [
    { id: 1, x: '25%', y: '30%', color: 'bg-red-500' },
    { id: 2, x: '45%', y: '45%', color: 'bg-blue-500' },
    { id: 3, x: '60%', y: '25%', color: 'bg-red-500' },
    { id: 4, x: '35%', y: '60%', color: 'bg-green-500' },
    { id: 5, x: '70%', y: '50%', color: 'bg-red-500' },
  ];
